...
на ассемблере слишком утомительно для меня, я решил сделать такой же диспетчер задач на С или С++, добавив 
пару функций, которых мне не хватало, когда я работал с ассмеблерной реализацией (автор DI_HALT).
Первая реализация на С/С++ была сделана а Atmel Studio, а раскопки ассмеблерного листинга после компиляции
